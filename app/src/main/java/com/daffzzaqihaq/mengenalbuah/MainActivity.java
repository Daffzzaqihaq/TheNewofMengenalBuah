...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO 4 Membuat object untuk adapter agar bisa digunakan dan mengisi parameter yg dibutuhkan
        Adapter adapter = new Adapter(MainActivity.this,gambar_buah,suara_buah,namabuah);

        //TODO 5 Mensetting recyclerview dan memasukan adapter ke recycleview
