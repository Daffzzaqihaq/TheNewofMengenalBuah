...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    // TODO 1 Membuat variable untuk menampung data pada saat object dibuat dan membawa data menggunakan prameter
    Context context;
    ...
    public Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        //mengembalikan nilai untuk memberitahu recycle view bahwa kita menggunakan view yang sudah kita buat
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter.ViewHolder viewHolder, final int i) {
        // Mengubah nama buah dengan data nama buah yang kita  miliki
        viewHolder.txtNamaBuah.setText(namaBuah[i]);
        // Menampilkan gambar dengan data gambar yang kita miliki menggunakan library Glide
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            //Menginisiasi/menghubungkan widget ke dalam variable yang sudah dibuat di atas
